...
function ThirdPartyButton({ style = {}, logo, brand, logoStyle = {}, textStyle = {}, type, onPress }: ThirdPartyButtonProps) {
  const loginHandler = useContext(LoginContext);

  return (
    <Pressable style={[styles.thirdPartyButton, style]} onPress={onPress}>
